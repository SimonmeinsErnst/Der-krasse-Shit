...
@GetMapping("/items-selektor")
    public String showSelektor(Model model) {
        ...
        // Wenn die Liste noch nicht vorhanden ist, erstellen eine neue ArrayList
...
*/
    @PostMapping("/items-selektor")
    public String assignItem(@RequestParam String itemSelect, @RequestParam String objectSelect, Model model, HttpSession session) {
        List<Item> items = getAppStore().getItemStore();

        
        List<String> fusedAssignments = (List<String>) session.getAttribute("fusedAssignments");

        // Wenn die Liste noch nicht vorhanden ist, erstelle eine neue ArrayList
        if (fusedAssignments == null) {
            fusedAssignments = new ArrayList<>();
        }
        ...
        session.setAttribute("fusedAssignments", fusedAssignments);
